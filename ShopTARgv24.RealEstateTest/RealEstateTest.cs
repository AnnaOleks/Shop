...
public class RealEstateTest : TestBase
{
    ...
    public async Task ShouldNot_GetByIdRealestate_WhenReturnsNotEqual1()
    {
        ...
        //Act
        await Svc<IRealEstateService>().DetailAsync(guid);
    ...
    public async Task Should_DeleteByIdRealestate_WhenDeleteRealestate1()
    {
        ...
        // Act
        var created1 = await Svc<IRealEstateService>().Create(dto);
        var delete1 = await Svc<IRealEstateService>().Delete((Guid)created1.Id);
    ...
    public async Task ShouldNot_DeleteByIdRealestate_WhenDidNotDeleteRealEsrare1()
    {
        ...
        // Act
        var created1 = await Svc<IRealEstateService>().Create(dto);
        var created2 = await Svc<IRealEstateService>().Create(dto);

        var result = await Svc<IRealEstateService>().Delete((Guid)created2.Id);
    ...
    public async Task Should_UpdateRealEstate_WhenUpdate1()
    {
        ...
        // Act
        await Svc<IRealEstateService>().Update(dto);
    ...
    public async Task Should_UpdateRealEstate_WhenUpdateData2()
    {
        ...
        // Act
        var createdRealEstate = await Svc<IRealEstateService>().Create(dto);
        var result = await Svc<IRealEstateService>().Update(updatedDto);
    ...
    public async Task ShouldNot_UpdateRealEstate_WhenDidNotUpdateDate()
    {
        ...
        var create1 = created1.CreatedAt;
        var update = created1.ModifiedAt;

        // Act – имитируем "фейковую кнопку": Update НЕ вызываем
        var fake = await Svc<IRealEstateService>().DetailAsync((Guid)created1.Id);
        ...
        Assert.Equal(create1, fake.CreatedAt);   // тут было update
